            ...
            <div class="card mt-4 border-0">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="pretty p-switch p-fill mb-2">
                            <input type="checkbox" id="all" name="all" :checked="rolePerms.length == model.length" @click="all($event)" />
                            <div class="state">
                        ...
                        <div v-for="(data, index) in model.all_perms" :key="index" class="collapseable_sec">
                            ...
                            <div class="perm-wrapper d-flex">
                                <template v-for="child in data">
                                    <div class="checkbox w-25 mx-2  mt-2" :key="child.id">
                                        <div class="pretty p-switch p-fill">
                                            <input type="checkbox" v-model="rolePerms" :data-id="`${child.id}`" :true-value="child.id" :value="child.id" />
                                            <div class="state">
                ...
                <div class="row justify-content-center">
                    <div class="col-4 mt-5">
                        <button class="btn btn-primary btn-block" v-on:click="assignPermissions">Submit</button>
